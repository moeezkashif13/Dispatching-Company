...
const allFAQS = [
        ...
        {heading:'How can I get paid for my loads?',paragraph:'Sky Dispatch LLC does not have its own MC, but instead relies on the MC of its carrier to book loads. When a load is delivered, the payment is received by the carrier, either directly from the broker or through their factoring company.'},
