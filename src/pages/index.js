...
<div className='font-bold'>
      <p className='text-2xl xs:text-lg'>WELCOME TO SAHMALL DISPATCH</p>

    <h1 className='text-7xl  leading-[70px] xs:text-4xl mt-7 mb-3 xs:my-4 uppercase'>Get Started With Us</h1>
    </div>
